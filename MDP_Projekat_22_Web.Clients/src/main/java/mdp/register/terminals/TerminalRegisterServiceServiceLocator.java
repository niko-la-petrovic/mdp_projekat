...
public class TerminalRegisterServiceServiceLocator extends org.apache.axis.client.Service
		implements mdp.register.terminals.TerminalRegisterServiceService {
	...
	public TerminalRegisterServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public mdp.register.terminals.TerminalRegisterService getTerminalRegisterService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			mdp.register.terminals.TerminalRegisterServiceSoapBindingStub _stub = new mdp.register.terminals.TerminalRegisterServiceSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (mdp.register.terminals.TerminalRegisterService.class.isAssignableFrom(serviceEndpointInterface)) {
				mdp.register.terminals.TerminalRegisterServiceSoapBindingStub _stub = new mdp.register.terminals.TerminalRegisterServiceSoapBindingStub(
						new java.net.URL(TerminalRegisterService_address), this);
				_stub.setPortName(getTerminalRegisterServiceWSDDServiceName());
				return _stub;
			}
