...
public class TerminalRegisterServiceProxy implements mdp.register.terminals.TerminalRegisterService {
	...
	private void _initTerminalRegisterServiceProxy() {
		try {
			terminalRegisterService = (new mdp.register.terminals.TerminalRegisterServiceServiceLocator())
					.getTerminalRegisterService();
			if (terminalRegisterService != null) {
				if (_endpoint != null)
					((javax.xml.rpc.Stub) terminalRegisterService)
							._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
				else
					_endpoint = (String) ((javax.xml.rpc.Stub) terminalRegisterService)
	...
	public void setEndpoint(String endpoint) {
		_endpoint = endpoint;
		if (terminalRegisterService != null)
			((javax.xml.rpc.Stub) terminalRegisterService)._setProperty("javax.xml.rpc.service.endpoint.address",
					_endpoint);
