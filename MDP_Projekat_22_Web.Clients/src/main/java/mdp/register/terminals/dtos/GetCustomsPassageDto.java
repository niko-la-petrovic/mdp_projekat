...
public class GetCustomsPassageDto  implements java.io.Serializable {
    ...
    private mdp.register.terminals.dtos.GetCustomsPassageStepDto[] passageSteps;
    ...
    public GetCustomsPassageDto(
           ...
           boolean open,
           mdp.register.terminals.dtos.GetCustomsPassageStepDto[] passageSteps) {
           this.entry = entry;
           this.id = id;
           this.open = open;
     ...
     * @return passageSteps
     */
    public mdp.register.terminals.dtos.GetCustomsPassageStepDto[] getPassageSteps() {
        return passageSteps;
    }
     ...
     * @param passageSteps
     */
    public void setPassageSteps(mdp.register.terminals.dtos.GetCustomsPassageStepDto[] passageSteps) {
        this.passageSteps = passageSteps;
    }
