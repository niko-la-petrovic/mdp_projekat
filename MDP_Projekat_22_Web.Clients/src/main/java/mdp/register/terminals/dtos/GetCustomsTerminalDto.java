...
public class GetCustomsTerminalDto  implements java.io.Serializable {
    private mdp.register.terminals.dtos.GetCustomsPassageDto[] entries;

    private mdp.register.terminals.dtos.GetCustomsPassageDto[] exits;
    ...
    public GetCustomsTerminalDto(
           mdp.register.terminals.dtos.GetCustomsPassageDto[] entries,
           mdp.register.terminals.dtos.GetCustomsPassageDto[] exits,
     ...
     * @return entries
     */
    public mdp.register.terminals.dtos.GetCustomsPassageDto[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(mdp.register.terminals.dtos.GetCustomsPassageDto[] entries) {
        this.entries = entries;
    }
     ...
     * @return exits
     */
    public mdp.register.terminals.dtos.GetCustomsPassageDto[] getExits() {
        return exits;
    }
     ...
     * @param exits
     */
    public void setExits(mdp.register.terminals.dtos.GetCustomsPassageDto[] exits) {
        this.exits = exits;
    }
