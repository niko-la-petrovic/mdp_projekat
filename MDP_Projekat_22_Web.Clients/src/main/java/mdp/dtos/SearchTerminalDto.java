...
public class SearchTerminalDto implements java.io.Serializable {
	private static final long serialVersionUID = -4354500655268428224L;
	...
	public SearchTerminalDto(boolean customsPassage, java.math.BigInteger passageId, java.lang.String terminalName) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof SearchTerminalDto))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.customsPassage == other.isCustomsPassage()
				&& ((this.passageId == null && other.getPassageId() == null)
						|| (this.passageId != null && this.passageId.equals(other.getPassageId())))
				&& ((this.terminalName == null && other.getTerminalName() == null)
						|| (this.terminalName != null && this.terminalName.equals(other.getTerminalName())));
		__equalsCalc = null;
		return _equals;
	}
